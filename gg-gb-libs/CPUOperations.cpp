...
void CPU::UbAdd(uint16_t & x,const uint8_t n,const bool carry){
	uint8_t ub = (x >> 8);
...
void CPU::UbSub(uint16_t & x,const uint8_t n,const bool carry){
	uint8_t ub = (x >> 8);
...
void CPU::LbSub(uint16_t & x,const uint8_t n,const bool carry){
	lb = 0x00FF & x;
	if(n != 1){
...
void CPU::LbAdd(uint16_t &x,const uint8_t n,const bool carry){
	lb = 0x00FF & x;
	if(n != 1){
